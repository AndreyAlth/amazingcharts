...
function NewClientHome({tap, setTap}) {
  return (
                    ...
                    <ul className="mb-5 overflow-y-auto whitespace-nowrap border-b border-[#ebedf2] font-semibold dark:border-[#191e3a] sm:flex">
                        <li className="inline-block">
                            <button
                                ...
                                className={`flex gap-2 border-b border-transparent p-4 hover:border-primary hover:text-primary ${tap === 2 ? '!border-primary text-primary' : ''}`}
                            >
                                <IconHome />
                                Home
                            </button>
                        ...
                        <li className="inline-block">
                            <button
                                onClick={() => setTap(3)}
                                className={`flex gap-2 border-b border-transparent p-4 hover:border-primary hover:text-primary ${tap === 3 ? '!border-primary text-primary' : ''}`}
                            >
                                <IconLocation/>
                                Payment Details
                            </button>
                        ...
                        <li className="inline-block">
                            <button
                                onClick={() => setTap(4)}
                                className={`flex gap-2 border-b border-transparent p-4 hover:border-primary hover:text-primary ${tap === 4 ? '!border-primary text-primary' : ''}`}
                            >
                        ...
                        <li className="inline-block">
                            <button
                                onClick={() => setTap(4)}
                                className={`flex gap-2 border-b border-transparent p-4 hover:border-primary hover:text-primary ${tap === 5 ? '!border-primary text-primary' : ''}`}
                            >
                                <IconPhone />
                                Danger Zone
                            </button>
